        <nav class="bg-gray-800">
                ...
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-navbar.nav-link href="/users">Users</x-nav-link>
                                    <x-navbar.nav-link href="/order">Order</x-nav-link>
                    ...
                    <div class="-mr-2 flex md:hidden">
                        ...
                        <button type="button"
                            ...
                            aria-controls="mobile-menu" aria-expanded="false" id="buttonHumberger">
            ...
            <div class="md:hidden hidden z-10 absolute bg-gray-800 w-[100%] " id="mobile-menu">
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    ...
                    <x-navbar.dropdown-link href="/order">Order</x-navbar.dropdown-link>
        ...
        <script>
            const button = document.getElementById('buttonHumberger')
